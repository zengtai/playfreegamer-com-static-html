...
export const SITE_META = {
  ...
  DESCRIPTION: `Join us at PlayFreeGamer and have fun playing the latest online casual games for free!`, // 网站描述
};
...
/* 3. 统计参数 */
export const GA_ID = `G-PVRC5QH5MX`; // Google Analytics ID

/* 4. 广告参数 / 设置 */
export const DEV_MODE = false; // 设置 data-adtest="on", 构建正式版本前需设置为 false
export const SHOW_AD = true; // 全局控制广告显示

export const ADSENSE_ID = `ca-pub-9062459637265650`; // Google AdSense ID,必须与域名匹配
// 广告ID
